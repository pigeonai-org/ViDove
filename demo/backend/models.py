...
class SessionConfig(BaseModel):
    ...
    translation_model: str = Field(default="gpt-5", alias="translation.model")
    ...
    MEMORY_enable_local_knowledge: bool = Field(default=True, alias="MEMORY.enable_local_knowledge")
    MEMORY_enable_web_search: bool = Field(default=False, alias="MEMORY.enable_web_search")
    MEMORY_enable_vision_knowledge: bool = Field(default=True, alias="MEMORY.enable_vision_knowledge")
    MEMORY_local_knowledge_path: str = Field(default="/home/macrodove/ViDove/domain_dict", alias="MEMORY.local_knowledge_path")
