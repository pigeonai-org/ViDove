...
export interface SessionConfig {
  ...
  'translation.model': "gpt-4" | "gpt-4o-mini" | "gpt-4o" | "Assistant" | "Multiagent" | "RAG";
  'translation.chunk_size': number;
  'audio.enable_audio': boolean;
  'audio.audio_agent': "GeminiAudioAgent";
  'audio.model_path': string | null;
  'audio.VAD_model': "pyannote/speaker-diarization-3.1" | "silero" | "API";
  'audio.src_lang': string;
  'audio.tgt_lang': string;
  'vision.enable_vision': boolean;
  'vision.vision_model': "CLIP" | "gpt-4o";
